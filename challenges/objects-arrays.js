...
const universities = [];
graduates.forEach(grads => universities.push(grads.university));
universities.sort();
...
const contactInfo = [];
graduates.forEach(grads => contactInfo.push(`${grads.first_name} ${grads.email}`));
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];
graduates.forEach(function(grads){
  if (grads.university.includes('Uni') === true){
    unisWithUni.push(grads.university)
  }
})
